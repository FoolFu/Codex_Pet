		...
		*/
		...
		__proto.traceInfo=function(){
			...
			for(var i = 0;i <this._resources.length; i++)
			{
				...
				{
					var isBig = tResource.width >= 512 || tResource.height >= 512;
					if(isBig)
					{
						var size = tResource.width * tResource.height/(1024*1024)*4;
						console.log(tResource.src + "-----width:" + tResource.width + "----height:" + tResource.height + "----size:" + size+"M");
						totalSize += size;
					} else
					{
						var size = tResource.width * tResource.height/(1024*1024)*4;
			...
			console.log("[Total memory of big:" + totalSize+"]"+"[Total memory of small:" + totalSize2+"]");
		}
		...
		*/
		...
		Stat.loop=function(){
			...
			Stat.FPS=Math.round((count *1000)/ (timer-Stat._timer));			
				...
				Laya.stage.event("qmdld_FPS_report");
	...
	var Text=(function(_super){
		...
		*/
		__getset(0,__proto,'fontSize',function(){
			...
			this._getCSSStyle().fontSize=parseInt(value);
			this.isChanged=true;
		});
	...
	var Stage=(function(_super){
		...
		*/
		...
		__proto._resetCanvas=function(){
			...
			Laya.timer.once(100,this,this._changeCanvasSize,null,false);
		}
...
/*  |xGv00|1a1d1800bc75d1177e17f48b147a51df */